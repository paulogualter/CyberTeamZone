              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {courses.map((course) => (
                  <motion.div
                    ...
                    className="group relative rounded-xl bg-slate-700 hover:bg-slate-600 transition-colors overflow-hidden border-2 border-gray-500 shadow-[0_0_15px_rgba(107,114,128,0.6)] hover:shadow-[0_0_25px_rgba(107,114,128,0.8)]"
                  >
                    {course.coverImage ? (
