        ...
        headers: [
          {
            key: 'Content-Security-Policy',
                   value: "default-src * 'unsafe-inline' 'unsafe-eval' 'unsafe-hashes' data: blob:; script-src * 'unsafe-inline' 'unsafe-eval' 'unsafe-hashes' 'unsafe-dynamic'; style-src * 'unsafe-inline' 'unsafe-hashes'; img-src * data: blob:; font-src * data:; connect-src *; media-src * data: blob:; object-src *; child-src * data: blob:; frame-src * data: blob:; worker-src *; frame-ancestors *; form-action *; base-uri *;"
          },
          {
