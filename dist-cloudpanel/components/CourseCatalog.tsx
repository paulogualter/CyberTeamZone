...
const mockCategories: Category[] = [
  { id: 'all', name: 'Todas as Categorias', description: 'All available courses', icon: '🔍', color: '#6366f1', courseCount: 0 },
      ...
      try {
        ...
        if (categoriesData.categories && categoriesData.categories.length > 0) {
          ...
          const transformedCategories = [
            { id: 'all', name: 'Todas as Categorias', description: 'All categories', icon: '🔍', color: '#6366f1', courseCount: coursesData.courses?.length || 0 },
